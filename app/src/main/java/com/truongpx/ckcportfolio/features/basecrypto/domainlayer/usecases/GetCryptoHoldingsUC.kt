...
class GetCryptoHoldingsUC @Inject constructor(val cryptoRepository: CryptoRepository) :
    UseCase<LiveData<List<CryptoHoldingModel>>, UseCase.None>() {

    override suspend fun run(params: None): Either<Failure, LiveData<List<CryptoHoldingModel>>>
    = cryptoRepository.getCryptoHoldings()
