...
/**
 * newInstance by truongpx
 */

class GetAllCryptoUC @Inject constructor(val cryptoRepository: CryptoRepository) :
    UseCase<LiveData<List<CryptoModel>>, UseCase.None>() {
    override suspend fun run(params: None): Either<Failure, LiveData<List<CryptoModel>>> =
