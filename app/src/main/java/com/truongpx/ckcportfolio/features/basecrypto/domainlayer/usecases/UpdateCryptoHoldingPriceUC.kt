...
class UpdateCryptoHoldingPriceUC @Inject constructor(val cryptoRepository: CryptoRepository) :
    UseCase<UseCase.None, UseCase.None>() {
    override suspend fun run(params: None): Either<Failure, None> = cryptoRepository.updateCryptoHoldingPrice()
}