...
class InsertIntoHoldingsUC @Inject constructor(val cryptoRepository: CryptoRepository) :
    UseCase<UseCase.None, List<CryptoHoldingModel>>() {
    override suspend fun run(params: List<CryptoHoldingModel>): Either<Failure, None>
            = cryptoRepository.insertIntoHoldings(params)
}
