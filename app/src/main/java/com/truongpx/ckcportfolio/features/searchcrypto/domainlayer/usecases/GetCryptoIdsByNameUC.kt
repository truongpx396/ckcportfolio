...
class GetCryptoIdsByNameUC @Inject constructor(val cryptoRepository: CryptoRepository) :
    UseCase<LiveData<List<CryptoModel>>, String>() {
    override suspend fun run(params: String): Either<Failure, LiveData<List<CryptoModel>>> =
        cryptoRepository.getCryptoIdsByName(params)
}