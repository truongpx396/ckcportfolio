...
class GetSearchInfoUC @Inject constructor(val cryptoRepository: CryptoRepository) :
    UseCase<LiveData<List<CryptoInfoModel>>, String>() {
    override suspend fun run(params: String): Either<Failure, LiveData<List<CryptoInfoModel>>> =
        cryptoRepository.getSearchInfo(params)
}