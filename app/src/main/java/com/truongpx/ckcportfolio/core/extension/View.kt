...
import com.truongpx.ckcportfolio.features.basecrypto.uilayer.customview.FlatRadioGroup
...
fun FlatRadioGroup.setOnItemClickListener(@Nullable onClickListener: (View) -> Unit) {
